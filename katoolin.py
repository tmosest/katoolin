...
5) Help
			...
			''')
				...
				opcion0 = f"{eval(input("\033[1;36mkat > \033[1;m"))}"
				print(f"Selected {opcion0}")
				while opcion0 == "1":
					print ('''
...
4) View the contents of sources.list file
					...
					''')
					repo = f"{eval(input("\033[1;32mWhat do you want to do ?> \033[1;m"))}"
...
''')
					repo = f"{eval(input("\033[1;32mDo you want to install classicmenu indicator ? [y/n]> \033[1;m"))}"
					if repo == "y":
					...
					repo =  f"{eval(input("\033[1;32mDo you want to install Kali menu ? [y/n]> \033[1;m"))}"
					if repo == "y":
...
0) All
			 ...
			 ''')
						...
						opcion1 =  f"{eval(input("\033[1;36mkat > \033[1;m"))}"
						if opcion1 == "back":
							inicio1()
						elif opcion1 == "gohome":
							inicio1()
...
0) Install all Information Gathering tools
						...
						''')
							...
							opcion2 = f"{eval(input("\033[1;36mkat > \033[1;m"))}"
							if opcion2 == "1":
